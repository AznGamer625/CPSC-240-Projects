...
gcc -m64 -no-pie -std=c11 -o exec.out manager.o main.o Input_Array.o Display_Array.o sum.o validate-decimal-digits.o atol.o read_clock.o bubble_sort.o swap.o
